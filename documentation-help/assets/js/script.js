...
$(document).ready(function() {
	...
	$(".stepsForm").stepsForm({
		width			:'50%',							//Plugin width %
		errormsg		:'Check faulty fields.',		//Form fields validate error message
		sendbtntext		:'Create Account',				//Last step Next button text.
		posturl			:'core/demo_steps_form.php',	//the file path for form data post action
		posterrormsg	:'Form post error.',			//if ajax form post result==false then mesage
		postsuccessmsg	:'Congragilations! Form post successfly!',	//if ajax form post result==true then mesage
		theme			:'red',						//Theme color. default:default. or green,purple,red,turquoise
	});
